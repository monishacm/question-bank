...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Add/Edit School Information</h2>
            ...
            <div class="x_content">
                ...
                <?php $list = ArrayHelper::map(Classes::find()->all(), 'id', 'title'); ?>
				<?php echo $form->field($model, 'class_id')->dropDownList($list, array('empty'=>'(Select a Class)')); ?>
